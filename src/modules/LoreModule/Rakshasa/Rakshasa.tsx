...
const Rakshasa = ({ id, setFaction }: Props) => {
  const rakshasasRef = useRef(null);
  const rakshasaInView = useInView(rakshasasRef);
      ...
      <article>
        <section>
          ...
          <StyledLoreContentDesc className="font-inter text-white-aeb mb-7">
            ...
            you, and make you whole. So beware, Rakshasha, demon of the night
          ...
          <StyledLoreContentDesc className="font-inter text-white-aeb mb-4">
            The Rakshasas are a fearsome and malevolent race of muscular fiends,
          ...
          <StyledLoreContentDesc className="font-inter text-white-aeb mb-4">
            Rakshasas are tall, brutish, and muscular, with dreads/thick hair
          ...
          <StyledLoreContentDesc className="font-inter text-white-aeb mb-4">
            Rakshasas are deeply selfish and prideful creatures, often roaming
          ...
          <StyledLoreContentDesc className="font-inter text-white-aeb mb-4">
            Rakshasas are highly intelligent and magic users, with a natural
          ...
          <StyledLoreContentDesc className="font-inter text-white-aeb mb-4">
            Rakshasas are almost universally evil, reveling in chaos and
